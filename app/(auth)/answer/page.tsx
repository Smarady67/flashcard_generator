...
export default function CardAnswerManager() {
  const [selectedCard, setSelectedCard] = useState({ 
    id: 1, 
    answer: 'Gold (Au) is a chemical element with the atomic number 79.' 
  });
          ...
          <div className="md:col-span-3 bg-white rounded-[40px] shadow-2xl overflow-hidden border border-white flex flex-col h-[500px]">
            ...
            <div className="p-12 flex-grow flex flex-col justify-center">
              <div className="flex items-start gap-4 mb-8">
                <span className="text-2xl font-bold text-[#2D3748] pt-1">Answer:</span>
                <textarea 
                  value={selectedCard.answer}
                  onChange={(e) => setSelectedCard({...selectedCard, answer: e.target.value})}
                  className="flex-grow text-xl font-medium text-[#4A5568] border-b-2 border-gray-400 focus:border-[#57B3D6] outline-none bg-transparent py-1 resize-none h-32"
